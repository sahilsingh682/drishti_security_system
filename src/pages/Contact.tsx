    ...
    <div className="min-h-screen bg-background grid-bg pt-20 pb-12 px-4">
      <div className="container mx-auto max-w-4xl">
        ...
        <div className="grid md:grid-cols-3 gap-4 mb-10">
          {[
            { icon: Phone, label: "Call Us", value: "+91 98120 19772", href: "tel:+919812019772" },
            { icon: MessageCircle, label: "WhatsApp", value: "Chat Now", href: "https://wa.me/919812019772" },
            { icon: Mail, label: "Email", value: "drishtisecuritysystem@gmail.com", href: "mailto:drishtisecuritysystem@gmail.com" },
          ].map((item, i) => (
